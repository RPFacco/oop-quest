# extract-base-screen Specification

## Purpose

Eliminate duplicated camera/viewport/batch/font lifecycle across simple Screen classes by extracting a reusable abstract base class.
